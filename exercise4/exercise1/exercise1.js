/*
    Mobile Programming - Paralel B
    Exercise #1

    Name : Dennis Billy Yosua Toreh
*/
...
//4. By using the dot notation, write the command to add a new key called is fun and a value of true to the programming object
